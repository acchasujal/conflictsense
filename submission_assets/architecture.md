...
## What Exists Today
- `DocumentAnalyzer` retrieves grounded evidence from Azure Foundry IQ on a per-document basis.
...
- It avoids hallucination by requiring grounded citations from Foundry IQ.
...
- We used Foundry IQ to keep every claim grounded.
